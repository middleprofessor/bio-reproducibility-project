...
> The rate of biofilm growth in experimental streams was influenced by the presence of wildlife inputs. There was a significant interaction between treatment and time for GPP (lme, interaction effect, F=3.033,32, P=0.044) and chl a (lme, interaction effect, F=3.443,32, P=0.028) (Fig. 5) indicating the rates of change in GPP and chl a were different among treatments. The rate of increase was greatest in the Hippo + WB treatment as compared to the Control for both GPP (lstrends pairwise comparison, t ratio: -2.7632, P=0.044) and chl a (lstrends pairwise comparison, t ratio:-3.0832, P=0.021).
