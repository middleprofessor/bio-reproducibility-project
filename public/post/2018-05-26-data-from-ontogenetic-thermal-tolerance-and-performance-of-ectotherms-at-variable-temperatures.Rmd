...
To compare to H&K models, we need estimates for change in $LTL$, $UTL$, $Tbr$ and possibly $OR$ across treatment effects. If the interation is smallish, report the pooled effects across both levels of the other treatment. Otherwise report the simple effects (differences within each level of the other treatment).
