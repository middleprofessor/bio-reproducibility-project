...
Reproducibility: 1 (fails to reproduce).

None of these result in F with anything near 14.9
...
Reproducibility: 1 (fails to reproduce) to 2 (reproduces to a similar value). My F for the interaction is massive relative to the reported value. The three values have an underlying similar pattern but the numbers aren't really close.
