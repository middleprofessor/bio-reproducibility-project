...
A plot of the estimated effect and difference in baseline (pre-treatment) $Mass$ shows that the lmm used by the authors does not correct for regression to the mean. That is, $E[Mass | X_{treatment} - X_{control}]$ is not zero but is a function of the baseline differnce $X_{treatment} - X_{control}$.
...
2. for 8-clip treatment lmm: 10.13, ANCOVA:6.55, cLDA: b=6.713
