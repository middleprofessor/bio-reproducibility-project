...
1. red flag: a method that I think is inferior is problematic or is simply wrong, or an interpretation that is wrong, or similar issues with the analysis.
...
```{r FRLplot, fig.cap="Reproducing Figure 3"}
