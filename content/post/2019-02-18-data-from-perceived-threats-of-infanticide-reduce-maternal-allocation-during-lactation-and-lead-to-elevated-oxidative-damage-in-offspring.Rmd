...
If we're focussing on p-values, then 1) the big difference is the p-value for Treatment and 2) another difference is that for Treatment x Sex. That said, it doesn't make much sense to interpret the Treatment p-value as evidence for "an effect" given the interactions.
